...
public class TabellaEntrataGruppi extends OggettoVistaBase {
    /**
	 * 
	 */
	...
	public static void setNomiColonne(String[] nomiColonne) {
		TabellaEntrataGruppi.nomiColonne = nomiColonne;
	}
...
//	}
	...
	public static void setPrimo(String[][] primo) {
		TabellaEntrataGruppi.primo = primo;
	}
	...
	public static void setTable(TableF table) {
		TabellaEntrataGruppi.table = table;
	}
