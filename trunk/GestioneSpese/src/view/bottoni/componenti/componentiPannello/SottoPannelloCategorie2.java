...
public class SottoPannelloCategorie2 extends OggettoVistaBase {
	...
	*/
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new SottoPannelloCategorie2());
	...
	public SottoPannelloCategorie2() {
		super();
		initGUI();
	}
	...
	public static void setTotaleMeseCategoria(JTextField totaleMeseCategoria) {
		SottoPannelloCategorie2.totaleMeseCategoria = totaleMeseCategoria;
	}
	...
	public static void setTotaleAnnualeCateg(JTextField totaleAnnualeCateg) {
		SottoPannelloCategorie2.totaleAnnualeCateg = totaleAnnualeCateg;
	}
