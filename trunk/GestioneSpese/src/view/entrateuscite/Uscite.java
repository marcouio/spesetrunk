...
public class Uscite extends AbstractUscite {
...
//					if(modelUscita.deleteLastSpesa()){
		...
		inserisci.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				setUscite();
				if(modelUscita.getnome()!=null && modelUscita.getdescrizione() !=null && modelUscita.getData()!=null && modelUscita.getDataIns()!=null &&
				   modelUscita.getCatSpese()!=null && modelUscita.getinEuro()!=0.0 && modelUscita.getUtenti()!=null){
